...
<head>
  ...
  $.ajax({
    url: "https://api.apispreadsheets.com/data/ssF2iNlt4mOGUYn6/",
    type: "post",
    data: {
...
<body>
  ...
  <h3>Engine Upgrades</h3>
    ...
    <label>
      <input type="checkbox" class="menu-item" data-price="8000"> Transmission Tier 3 - $8000
      <input type="number" class="quantity" value="1" min="1">
    </label>
	...
	<h3>Repairs</h3>
    <label>
      <input type="checkbox" class="menu-item" data-price="1400"> Standard Repair (D- Class) - $1400
      <input type="number" class="quantity" value="1" min="1">
    </label>
	...
	<h3>Misc Items</h3>
    <label>
      <input type="checkbox" class="menu-item" data-price="325"> Single Lockpick - $325 
      <input type="number" class="quantity" value="1" min="1">
    </label>
    <label>
	...
	<h3>Towing</h3>
    <label>
      <input type="checkbox" class="menu-item" data-price="250"> Los Santos - 250$
      <input type="number" class="quantity" value="1" min="1">
    </label>
    <label>
	...
	<label>
      <input type="checkbox" class="menu-item" data-price="750"> Paleto - 750$
      <input type="number" class="quantity" value="1" min="1">
    </label>
    ...
    <p>Commission (5%): $<span id="commission"></span></p>
